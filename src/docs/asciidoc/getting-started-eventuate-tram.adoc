...
=== Simplified getting started guide for Spring Boot/Gradle-based applications

If you are using Spring Boot with Gradle, you can use the following simplified guide to get started with Eventuate Tram:
link:./getting-started-eventuate-tram-spring-boot.html[Getting started with Eventuate Tram for Spring Boot-based applications].
