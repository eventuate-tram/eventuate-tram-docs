...
dependencies {
  ...
  testCompile "io.eventuate.tram.core:eventuate-tram-micronaut-in-memory:$eventuateTramVersion"
...
| Dependency
| `eventuate-tram-spring-consumer-jdbc` directly or indirectly via `eventuate-tram-spring-jdbc-<message-broker>`
| `eventuate-tram-spring-consumer-jdbc` directly or indirectly via `eventuate-tram-spring-jdbc-<message-spring-jdbc-<message-broker>`
| -
