...
The latest versions (spring/micronaut) are:
...
The latest versions (quarkus) are:
...
dependency {
  ...
  compile "io.eventuate.tram.sagas:eventuate-tram-sagas-quarkus-orchestration-simple-dsl:$eventuateTramSagasVersion"
...
dependency {
  ...
  compile "io.eventuate.tram.sagas:eventuate-tram-sagas-quarkus-participant:$eventuateTramSagasVersion"
