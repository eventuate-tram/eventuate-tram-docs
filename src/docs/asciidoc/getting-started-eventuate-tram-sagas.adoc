...
* `io.eventuate.tram.sagas:eventuate-tram-sagas-micronaut-orchestration:$eventuateTramSagasVersion`
...
* `io.eventuate.tram.core:eventuate-tram-micronaut-producer-jdbc:$eventuateTramVersion`
* `io.eventuate.tram.core:eventuate-tram-micronaut-consumer-kafka`
* `io.eventuate.tram.core:eventuate-tram-micronaut-consumer-jdbc:$eventuateTramVersion`

In-memory JDBC database and in-memory messaging for testing

* `io.eventuate.tram.core:eventuate-tram-micronaut-in-memory:$eventuateTramVersion`
